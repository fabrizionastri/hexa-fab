...
import { OrderAdapterIM } from './order.adapter.im'
import { OrderAdapterJS } from './../jsonServer/order.adapter.js'
...
const orderAdapters = [
  { adapterName: 'OrderAdapterIM', orderAdapter: OrderAdapterIM },
  { adapterName: 'OrderAdapterJS', orderAdapter: OrderAdapterJS },
]
